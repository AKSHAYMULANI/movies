...
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '933064491').split()]
USERNAME = environ.get('USERNAME', "https://t.me/akshaymulani") # ADMIN USERNAME
...
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'https://arolinks.com/api')
SHORTENER_API2 = environ.get("SHORTENER_API2", "1bb101f6edcd5e1298f96b50a78f15252a3f8f4d")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'https://arolinks.com/api')
SHORTENER_API3 = environ.get("SHORTENER_API3", "1bb101f6edcd5e1298f96b50a78f15252a3f8f4d")
SHORTENER_WEBSITE3 = environ.get("SHORTENER_WEBSITE3", 'https://arolinks.com/api')
